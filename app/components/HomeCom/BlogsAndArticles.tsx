        ...
        <section className="py-12 md:py-16 px-6 md:px-12 lg:px-24">
            <div className="max-w-[1400px] mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {/* Text Card */}
                    <div className="bg-blue border border-white/10 rounded-2xl p-8 md:p-12 flex flex-col justify-between h-[550px] md:h-[600px] relative group hover:border-white/30 transition-colors duration-500">
                    ...
                    {/* Image Card */}
                    <div className="bg-blue border border-white/10 rounded-2xl p-2 h-[500px] md:h-[600px] relative overflow-hidden group">
