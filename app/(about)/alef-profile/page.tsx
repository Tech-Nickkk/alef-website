        ...
        <div className="bg-background min-h-screen flex flex-col relative overflow-hidden">
            ...
            <main className="grow pt-32 px-4 md:px-8 lg:px-12 max-w-[1400px] mx-auto w-full z-10 relative">
                ...
                <div className="mb-20 text-center max-w-5xl mx-auto">
                    <AnimatedTitle
                        text="ALEF PROFILE"
                        className="text-6xl md:text-8xl font-bebas text-foreground mb-6 justify-center flex"
                    />
                    <div className="h-1 w-24 bg-red mx-auto mb-8"></div>
                    <p className="font-oswald text-xl md:text-2xl text-foreground/80 leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-24">
                    {/* Vision Card */}
                    <div className="bg-blue border border-white/10 hover:border-white/30 rounded-2xl group transition-all duration-300 relative overflow-hidden p-12 flex flex-col">
                        <div className="relative z-10">
                            <h2 className="text-4xl font-bebas text-white mb-6 group-hover:text-red transition-colors">Our Vision</h2>
                    ...
                    {/* Mission Card */}
                    <div className="bg-blue border border-white/10 hover:border-white/30 rounded-2xl group transition-all duration-300 relative overflow-hidden p-12 flex flex-col">
                        <div className="absolute top-6 right-6 text-red/20 group-hover:text-red/40 transition-colors">
                            <Flag className="w-16 h-16" />
                        </div>
                        <div className="relative z-10">
                            <h2 className="text-4xl font-bebas text-white mb-6 group-hover:text-red transition-colors">Our Mission</h2>
                            <ul className="space-y-4 font-oswald text-white/70 text-lg">
                                {[
                                    ...
                                    <li key={index} className="flex items-start gap-3">
                                        <span className="w-1.5 h-1.5 bg-red rounded-full mt-2.5 shrink-0"></span>
                                        <span>{item}</span>
                                    </li>
                                ))}
                            </ul>
                ...
                <section className="mb-24">
                    <div className="flex items-center gap-4 mb-10">
                        ...
                        <h2 className="text-3xl font-bebas text-foreground tracking-wide">Organizational Structure</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={idx} className="bg-blue border border-white/10 p-8 rounded-2xl hover:bg-blue/80 transition-all duration-300 group text-center flex flex-col items-center">
                                <div className="mb-6 text-white/50 group-hover:text-red transition-colors duration-300">
                                    {item.icon}
                                </div>
                ...
                <section className="mb-24">
                    <div className="flex flex-col md:flex-row gap-6">
                        <div className="md:w-1/3">
                            <h2 className="text-5xl font-bebas text-foreground mb-4">Diversity of Voices</h2>
                            <p className="font-oswald text-foreground/60 text-lg">
                                Reflecting Lebanon's rich demographics and ensuring every community is heard.
                            </p>
                        </div>
                        <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-blue border border-white/10 p-8 rounded-2xl hover:border-red/50 transition-colors duration-300">
                ...
                <section className="mb-20 pt-10 border-t border-foreground/10">
                    <div className="flex items-end justify-between mb-10">
                        <div>
                            <h2 className="text-4xl font-bebas text-foreground mb-2">Metrics for Success</h2>
                            <p className="font-oswald text-foreground/50">Ensuring accountability in our initiatives</p>
                        </div>
                        <Award className="w-10 h-10 text-red opacity-50 hidden md:block" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={i} className="flex items-center p-6 bg-blue border border-white/10 rounded-xl hover:border-red/50 transition-all duration-300 gap-4">
